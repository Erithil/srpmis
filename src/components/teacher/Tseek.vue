<template>
    <div class="info">
        <div class="search">
         <input class="search__input" type="text" placeholder="输入ID查询" v-model="seek.sear"/>
                ...
                uid: this.seek.sear,             
                    ...
                    if (content.length != 0) {
                        for(let i=0;i<content.length;i++){
                            ...
                            td1.innerHTML = content[i].username;
                            tr.appendChild(td1);
                            ...
                            td5.innerHTML = content[i].userroot;
                            tr.appendChild(td5);
